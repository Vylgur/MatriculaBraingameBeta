...
setupPopup('send-button4', 'popup4', 'https://forms.gle/AR4jFjYMzukwkPzN8');
setupPopup('send-button5', 'popup5', 'https://forms.gle/7GKuNvrCVrHSdNBg7');
setupPopup('send-button6', 'popup6', 'https://forms.gle/Z1szpEDqUizkW4bs5'); 
